...
const TroubleshootingForm = () => {
      ...
      try {
        ...
        if (storedCategories) {
          ...
          const troubleshootingCategory = categories.find(
            cat => cat.name === 'TROUBLESHOOTING'
          );
          
          if (troubleshootingCategory && !troubleshootingCategory.active) {
        ...
        >
          <Box sx={{ textAlign: 'center', py: 4 }}>
            ...
            <Typography variant="h6" paragraph color="text.secondary">
              The Troubleshooting module is currently under maintenance
            </Typography>
            <Typography variant="body1" sx={{ mb: 4, maxWidth: '600px', mx: 'auto' }}>
              Our team is working to improve this feature. The Troubleshooting ticket category has been temporarily disabled by the system administrator.
            </Typography>
            <Button 
              variant="contained" 
              color="primary"
  ...
  return (
    <Container maxWidth="md" sx={{ py: 4 }}>
      {/* Form content */}
      <Typography variant="h4">Troubleshooting Form</Typography>
