      ...
      try {
        ...
        if (storedCategories) {
          ...
          const documentCategory = categories.find(
            cat => cat.name === 'DOCUMENT_UPLOAD'
          );
          
          if (documentCategory && !documentCategory.active) {
        ...
        >
          <Box sx={{ textAlign: 'center', py: 4 }}>
            ...
            <Typography variant="h6" paragraph color="text.secondary">
              The Document Upload module is currently under maintenance
            </Typography>
            <Typography variant="body1" sx={{ mb: 4, maxWidth: '600px', mx: 'auto' }}>
              Our team is working to improve this feature. The Document Upload ticket category has been temporarily disabled by the system administrator.
            </Typography>
            <Button 
              variant="contained" 
              color="primary"
